...
class CustomSelectBox {
    ...
    Color? fillColor,
      ...
      themeSelectBox(
        ...
        child: Checkbox(
          value: value,
          onChanged: onChanged,
          activeColor: activeColor ?? AppColor.secondaryColor,
          checkColor: checkColor ?? (isCircle ? AppColor.secondaryColor : AppColor.white),
        ),
      );
  ...
  static Widget singleCheckBox({
    ...
    bool isCircle = true,
    Color? fillColor,
    Color activeColor = AppColor.secondaryColor,
