...
class ColorCodeSelectController extends GetxController {
  ...
  final RxList<ColorCode> colorCodes = RxList();
  ...
  Future<void> onLoading() async {
    ...
    try {
      final result = await ProductStore.to.getColorCodes(
        page: loadMoreCounter.page,
        pageSize: loadMoreCounter.pageSize,
      );

      colorCodes.addAll(result.data);
