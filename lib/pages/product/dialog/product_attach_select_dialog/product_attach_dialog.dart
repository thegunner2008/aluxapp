...
class ProductAttachSelectDialog extends StatefulWidget {
  const ProductAttachSelectDialog({Key? key}) : super(key: key);

  @override
  State<ProductAttachSelectDialog> createState() => _SelectDialogState();
}

class _SelectDialogState extends State<ProductAttachSelectDialog> {
  final _controller = Get.put(ProductAttachSelectController());
                  ...
                  () => Expanded(
                    child: AppRefresher(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => ProductAttachItem(
                          product: _controller.products[index],
                          onSelect: () =>
                              context.popNavigator<Product>(_controller.products[index]),
                        ),
                      ),
                    ),
                  ),
