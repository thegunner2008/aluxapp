...
import 'package:aluxapp/pages/main/index.dart';
...
class DrawerBarWidget extends StatelessWidget {
  ...
  Widget _menuItemWithChild(
    ...
    for (int index = 0; index < menuModels.length; index++) {
      ...
      final Color subTextColor = subIsSelected ? AppColor.secondaryColor : AppColor.black800;
      menuModelChild.add(
        Padding(
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final Color textColor = isSelected ? AppColor.secondaryColor : AppColor.black800;
                return _menuItem(
                  context,
                  textColor: textColor,
                  haveChild: haveChild,
