...
import 'package:aluxapp/common/entities/setting_model.dart';
          ...
          child: Column(
            children: [
              Icon(Icons.sell_outlined,
                  color: AppColor.secondaryColor, size: 60.scaleSize),
              VSpace.lg,
              Row(
                children: [
              ...
              ...vatTypeMap.entries.map(
                (e) => CustomButton.outline(
                  ...
                  text: e.value,
                  borderColor:
                      _vatType == e.key ? AppColor.secondaryColor : AppColor.grey300,
